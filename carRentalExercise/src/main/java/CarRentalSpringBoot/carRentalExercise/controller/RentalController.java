...
public class RentalController {
    ...
    @PostMapping("/")
    public ResponseEntity<RentalGetDto> addNewRental(@Valid @RequestBody RentalCreateDto rental) throws CarIdNotFoundException, ClientIdNotFoundException, CarIsNotAvailableException {

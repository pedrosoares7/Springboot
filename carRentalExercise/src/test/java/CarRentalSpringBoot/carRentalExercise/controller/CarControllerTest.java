...
class CarControllerTest {
    ...
    void testCreateCarReturnCreateAndGetIdEqualsTo1() throws Exception {
        ...
        CarCreateDto car = objectMapper.readValue(responseContent, CarCreateDto.class);

        //assert student id and name using matchers
        // assertThat(car.getId()).isEqualTo(1L);
        assertThat(car.brand()).isEqualTo("BMW");
        assertThat(car.plate()).isEqualTo("XX-01-XX");
        assertThat(car.dailyRentalPrice()).isEqualTo(50);
    }
